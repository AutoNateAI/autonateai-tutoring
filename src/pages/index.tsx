    ...
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <p className="hero__subtitle">
          We transform <span className="hero-highlight-gold">Theoretical Breakthroughs</span> into <span className="hero-highlight-gold">Industrial Excellence</span>. Mastering the high-signal patterns required for the <span className="hero-highlight-gold">Next Generation of Software Engineering</span>.
        </p>
