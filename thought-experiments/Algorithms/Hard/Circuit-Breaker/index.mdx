...
description: "A dual-algorithm DFS+BFS emergency through Grand Rapids ArtPrize territory."
sidebar_position: 2
image: /img/quests/circuit-breaker/scene-01-midnight-alert.png
---

import CardSlam from "@site/src/components/CardSlam";

<CardSlam
  question="When DFS Meets BFS: The Grand Rapids Rescue"
  subtext="A Dual-Algorithm Emergency Through ArtPrize Territory"
/>
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-01-midnight-alert.png" alt="Dr. Nate Chen on the Blue Bridge at night during the emergency alert" />
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-02-heritage-hill.png" alt="Maya Patel at her Heritage Hill Victorian home surrounded by laptop screens showing graph visualizations" />
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-03-zoo-war-room.png" alt="The team gathered around the 30-foot waterfall at John Ball Zoo with holographic graph visualizations" />
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-04-rooftop-strategy.png" alt="The team on the rooftop café at John Ball Zoo overlooking Grand Rapids at dawn with historic bridges visible" />
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-05-code-deploys.png" alt="Priya Okoye coding intensely with Python DFS and BFS code on screen, downtown Grand Rapids in background" />
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-06-heritage-test.png" alt="Heritage Hill historic neighborhood with visitors using the navigation app successfully" />
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-07-meijer-deployment.png" alt="The team celebrating successful deployment at Meijer Gardens sculpture park with colorful glass art" />
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-08-victory-metrics.png" alt="Close-up of smartphone showing victory metrics dashboard with 60 percent reduction and 94 percent coverage" />
...
<img className="quest-image" src="/img/quests/circuit-breaker/scene-09-grand-rapids-flows.png" alt="Epic panoramic view of Grand Rapids at sunset with glowing flow lines connecting venues across the city" />
